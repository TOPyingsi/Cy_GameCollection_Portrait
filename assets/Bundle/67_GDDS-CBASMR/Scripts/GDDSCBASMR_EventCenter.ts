...
export class GDDSCBASMR_EventCenter {
    private static _instance: GDDSCBASMR_EventCenter;
     ...
     * 获取事件中心的单例实例
     */
    public static get instance(): GDDSCBASMR_EventCenter {
        if (!this._instance) {
            this._instance = new GDDSCBASMR_EventCenter();
        }
...
// 导出单例实例
export const eventCenter = GDDSCBASMR_EventCenter.instance;