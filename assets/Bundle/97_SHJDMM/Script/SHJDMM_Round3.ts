import { _decorator, Component, director, EventTouch, Node, Sprite, SpriteFrame, UITransform, v2, Vec3 } from 'cc';
import { SHJDMM_Touch } from './SHJDMM_Touch';
import { SHJDMM_GameManager } from './SHJDMM_GameManager';
const { ccclass, property } = _decorator;

@ccclass('SHJDMM_Round3')
export class SHJDMM_Round3 extends Component {
    ...
    protected onLoad(): void {
        ...
        director.on("round3_changeSf", this.changeSf, this);
    }
    ...
    private onDoubleClick(role: Node): void {
        console.log(`round3 Double click on ${role.name}`);

        console.log("round3 before", SHJDMM_Touch.instance?.roles);
        ...
        console.log("round3 after", SHJDMM_Touch.instance?.roles);
    }
}