import { _decorator, Component, find, geometry, Node, Material, math, MeshRenderer, PhysicsSystem, SkeletalAnimation, SkinnedMeshRenderer, tween, Vec3 } from 'cc';
...
@ccclass('XCJZ_PlayerController_Bound')
export class XCJZ_PlayerController_Bound extends Component {
    @property(Material)
    ...
    protected onLoad(): void {
        this.BodyMesh = find("Sphere/Sphere", this.node).getComponent(MeshRenderer);
    }
