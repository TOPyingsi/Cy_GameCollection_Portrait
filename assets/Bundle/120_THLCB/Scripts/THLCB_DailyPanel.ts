...
@ccclass('THLCB_DailyPanel')
export class THLCB_DailyPanel extends THLCB_UIBase {
    ...
    _CheckDaily() {
        let daily = THLCB_DataManager.Instance.getNumberData("Daily");
        let day = daily % 7;
    ...
    DailyButton() {
        ...
        THLCB_DataManager.Instance.setArrayData("LastDaily", lastDaily);
        let daily = THLCB_DataManager.Instance.getNumberData("Daily");
        daily++;
        THLCB_DataManager.Instance.setNumberData("Daily", daily);
        let day = daily % 7;
        ...
        this.scheduleOnce(() => {
            THLCB_DataManager.coinSpawn = target.children[0].getWorldPosition();
