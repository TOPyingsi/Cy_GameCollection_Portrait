...
export class SHJCB_EventCenter {
    private static _instance: SHJCB_EventCenter;
     ...
     * 获取事件中心的单例实例
     */
    public static get instance(): SHJCB_EventCenter {
        if (!this._instance) {
            this._instance = new SHJCB_EventCenter();
        }
...
// 导出单例实例
export const eventCenter = SHJCB_EventCenter.instance;