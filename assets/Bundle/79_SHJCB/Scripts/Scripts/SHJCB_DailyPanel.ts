...
@ccclass('SHJCB_DailyPanel')
export class SHJCB_DailyPanel extends SHJCB_UIBase {
    ...
    _CheckDaily() {
        let daily = SHJCB_DataManager.Instance.getNumberData("Daily");
        let day = daily % 7;
    ...
    DailyButton() {
        ...
        SHJCB_DataManager.Instance.setArrayData("LastDaily", lastDaily);
        let daily = SHJCB_DataManager.Instance.getNumberData("Daily");
        daily++;
        SHJCB_DataManager.Instance.setNumberData("Daily", daily);
        let day = daily % 7;
        ...
        this.scheduleOnce(() => {
            SHJCB_DataManager.coinSpawn = target.children[0].getWorldPosition();
