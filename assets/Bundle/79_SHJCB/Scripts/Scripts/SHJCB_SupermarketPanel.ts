...
@ccclass('SHJCB_SupermarketPanel')
export class SHJCB_SupermarketPanel extends SHJCB_UIBase {

    private static instance: SHJCB_SupermarketPanel;
    public static get Instance(): SHJCB_SupermarketPanel {
    ...
    protected onLoad(): void {
        super.onLoad();
        SHJCB_SupermarketPanel.instance = this;
    ...
    protected _InitData(): void {
        SHJCB_AudioManager.Instance._PlaySPMKMusic();
        this.doorOpen = false;
    ...
    OpenDoors() {
        ...
        this.doorOpen = true;
        this.doors.play();
        SHJCB_AudioManager.Instance._PlaySound(3);
    }
    ...
    ChooseItem(event: Event, num: number) {
        ...
        if (this.cost + price > coin) SHJCB_MainPanel.Instance._OpenNeed();
    ...
    _ScanTouchMove(event: EventTouch) {
        ...
        if (this.scan.node.children[2].getComponent(UITransform).getBoundingBoxToWorld().contains(pos)) {
            SHJCB_AudioManager.Instance._PlaySound(4);
    ...
    FinishDone() {
        SHJCB_AudioManager.Instance._PlaySound(5);
        ...
        this.scheduleOnce(() => {
            ...
            SHJCB_MainPanel.Instance.supermarketLivePanel.active = true;
        }, 2);
    }
