...
@ccclass('SHJCB_Achievement')
export class SHJCB_Achievement extends Component {
    ...
    _Init(num: number) {
        let fanLimit = SHJCB_DataManager.fanLevelNums[num];
        ...
        let name = SHJCB_DataManager.fanLevelNames[num];
