...
export enum BZLGYJJF_Touch_ObjectType {
    单击按下触发 = 0,
    拖拽式 = 1,
    方向拖拽抬起触发 = 2,

}
@ccclass('BZLGYJJF_TouchMonitor')
export class BZLGYJJF_TouchMonitor extends Component {
    @property
    ID: number = 0;
    @property({ type: Enum(BZLGYJJF_Touch_ObjectType) })
    ObjectType: BZLGYJJF_Touch_ObjectType = BZLGYJJF_Touch_ObjectType.单击按下触发;
    @property({ type: [Node] })
    public TargetNode: Node[] = [];//目标对象
