...
@ccclass('TZHZ_BiaoQing')
export class TZHZ_BiaoQing extends Component {
    ...
    onTouchEnd() {
        ...
        find("Canvas/工作台/表情").addChild(PipingNode);

        if (find("Canvas/工作台/表情").children.length > 1) {
            find("Canvas/工作台/表情").children[0].destroy();
        }
