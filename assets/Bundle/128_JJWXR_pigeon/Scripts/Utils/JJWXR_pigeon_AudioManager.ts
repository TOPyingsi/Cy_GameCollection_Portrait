...
export class JJWXR_pigeon_AudioManager {
    private static _instance: JJWXR_pigeon_AudioManager;
    public static get instance(): JJWXR_pigeon_AudioManager {
        if (this._instance == null) {
            this._instance = new JJWXR_pigeon_AudioManager();
        }
