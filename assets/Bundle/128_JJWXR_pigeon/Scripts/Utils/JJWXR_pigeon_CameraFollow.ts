...
import { JJWXR_pigeon_Bullet } from '../Game/JJWXR_pigeon_Bullet';
const { ccclass, property } = _decorator;

@ccclass('JJWXR_pigeon_CameraFollow')
export class JJWXR_pigeon_CameraFollow extends Component {
    ...
    private bulletScript: JJWXR_pigeon_Bullet = null;

    start() {
        // 获取子弹脚本
        this.bulletScript = this.bulletNode.getComponent(JJWXR_pigeon_Bullet);
