...
export class JJWXR_pigeon_EventCenter {
    private static _instance: JJWXR_pigeon_EventCenter;
     ...
     * 获取事件中心的单例实例
     */
    public static get instance(): JJWXR_pigeon_EventCenter {
        if (!this._instance) {
            this._instance = new JJWXR_pigeon_EventCenter();
        }
...
// 导出单例实例
export const eventCenter = JJWXR_pigeon_EventCenter.instance;