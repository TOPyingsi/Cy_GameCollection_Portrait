...
@ccclass('JJWXR_pigeon_GameTimeCountDown')
export class JJWXR_pigeon_GameTimeCountDown extends Component {
    ...
    start() {
        ...
        eventCenter.on(JJWXR_pigeon_Events.GAME_START, this.startCountdown, this); // 监听游戏开始事件
        eventCenter.on(JJWXR_pigeon_Events.GAME_STOP, this.pauseCountdown, this); // 监听游戏开始事件
        eventCenter.on(JJWXR_pigeon_Events.GAME_RESUME, this.resumeCountdown, this); // 监听游戏结束事件
        eventCenter.on(JJWXR_pigeon_Events.GAME_OVER, this.stopCountdown, this); // 监听游戏暂停事件
    }

    onDestroy() {
        // 在组件销毁时，取消事件监听
        eventCenter.off(JJWXR_pigeon_Events.GAME_START, this.startCountdown, this);
        eventCenter.off(JJWXR_pigeon_Events.GAME_STOP, this.pauseCountdown, this);
        eventCenter.off(JJWXR_pigeon_Events.GAME_RESUME, this.resumeCountdown, this);
        eventCenter.off(JJWXR_pigeon_Events.GAME_OVER, this.stopCountdown, this);
    }
    ...
    getTime() {
        ...
        if (this.isCountdownEnd()) {
            console.log("倒计时结束");
            eventCenter.emit(JJWXR_pigeon_Events.SHOW_FAILED_UI); // 发送游戏结束事件
        }
        if (!this.isCounting) {
            return;
        }
