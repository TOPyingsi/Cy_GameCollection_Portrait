...
@ccclass('JJWXR_pigeon_Tutorial')
export class JJWXR_pigeon_Tutorial extends Component {
    ...
    start() {
        eventCenter.on(JJWXR_pigeon_Events.GUN_FIRED, this.classIsOver, this);
    ...
    onDisable() {
        eventCenter.off(JJWXR_pigeon_Events.GUN_FIRED, this.classIsOver, this);
    }
