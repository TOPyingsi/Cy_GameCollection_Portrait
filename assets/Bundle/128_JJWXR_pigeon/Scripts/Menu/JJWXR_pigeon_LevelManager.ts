...
@ccclass('JJWXR_pigeon_LevelManager')
export class JJWXR_pigeon_LevelManager extends Component {
    ...
    onLoad() {
        ...
        // currentLevel++;
        // localStorage.setItem('JJWXR_pigeon_currentLevel', urrentLevel);
        // let curlevel = parseInt(localStorage.getItem('JJWXR_pigeon_currentLevel'));
        // console.log('level:', curlevel);
    }

    saveLevelData() {
        // 定义关卡数据
        let data = localStorage.getItem('JJWXR_pigeon_currentLevel');
        let currentLevel = 1;
        ...
        let data3 = localStorage.getItem('JJWXR_pigeon_setting');
        ...
        // const setting = localStorage.getItem('JJWXR_pigeon_setting') || { sound: true, oscillation: true };

        const isFirstPlay = localStorage.getItem('JJWXR_pigeon_isFirstPlay') || "true";
        ...
        localStorage.setItem('JJWXR_pigeon_isFirstPlay', isFirstPlay);
        // 将关卡数据保存到本地存储
        let level = localStorage.getItem('JJWXR_pigeon_currentLevel');
        if (!level || level == '') localStorage.setItem('JJWXR_pigeon_currentLevel', "1");///////////改当前关卡

        localStorage.setItem('gunIndex', gunIndex.toString());

        localStorage.setItem('JJWXR_pigeon_setting', JSON.stringify(setting));
