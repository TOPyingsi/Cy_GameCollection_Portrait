...
export class LevelData {
    public static GAMESCENE: string = "JJWXR_pigeon_ShootAndHide";
    // public static GAMESCENE: string = "JJWXR_pigeon_GameScene00";
    public static LEVEL01: number = 1;
}
@ccclass('JJWXR_pigeon_Loading')
export class JJWXR_pigeon_Loading extends Component {
    @property(Node)
