...
import { DMM_ColorRGBA, DMM_ContentColor } from '../Script/DMM_Constant';
...
export class Label3D extends Component {
    @property({ type: Enum(DMM_ContentColor) })
    color: DMM_ContentColor = DMM_ContentColor.WHITE;

    get Color() {
        return this.color;
    }
    set Color(val: DMM_ContentColor) {
        this.color = val;
    ...
    private updateTexture(): void {
        ...
        this._context.strokeStyle = 'rgba(0, 0, 0, 255)';
    ...
    private updateFontRenderingStyle(): void {
        ...
        const color: Color = DMM_ColorRGBA[this.color];
