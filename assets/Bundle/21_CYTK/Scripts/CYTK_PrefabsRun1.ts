import { _decorator, Collider2D, Component, Contact2DType, error, EventTouch, find, IPhysics2DContact, Node, PhysicsSystem2D, tween, UITransform, v3, Vec3 } from 'cc';
import { CYTK_GameManger1 } from './CYTK_GameManger1';
import { CYTK_AudManager } from './CYTK_AudManager';
const { ccclass, property } = _decorator;

@ccclass('CYTK_PrefabsRun1')
export class CYTK_PrefabsRun1 extends Component {
    ...
    private onDrop() {
        ...
        if (this.OtherName == this.NodeName) {
            ...
            if (this.Touch != false) {
                CYTK_GameManger1.Instance._win += 1;
            }
