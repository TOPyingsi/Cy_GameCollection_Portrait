...
@ccclass('YSMNQ_HYC_SecondPanel_0')
export class YSMNQ_HYC_SecondPanel_0 extends Component {
    static Instance: YSMNQ_HYC_SecondPanel_0 = null;
    ...
    onLoad(){
        YSMNQ_HYC_SecondPanel_0.Instance = this;
