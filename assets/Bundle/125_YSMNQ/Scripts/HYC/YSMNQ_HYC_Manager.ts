...
@ccclass('YSMNQ_HYC_Manager')
export class YSMNQ_HYC_Manager extends YSMNQ_ManagerBase {
    static Instance: YSMNQ_HYC_Manager = null;
    ...
    onLoad(){
        YSMNQ_HYC_Manager.Instance = this;
    }
    ...
    startGame(): void {
        ...
        this.showPeopleReact(YSMNQ_HYC_PeopleState.迷糊);
    ...
    passGame(): void {
       ...
       this.showPeopleReact(YSMNQ_HYC_PeopleState.治好);
    ...
    showPeopleReact(state: YSMNQ_HYC_PeopleState): void {
        switch(state){
            case YSMNQ_HYC_PeopleState.张嘴:
            case YSMNQ_HYC_PeopleState.正常:
            case YSMNQ_HYC_PeopleState.迷糊:
                ...
                this.peopleStatusNode.getChildByName("status_1").active = false;
                break;
            // case YSMNQ_HYC_PeopleState.咬紧牙关:
            //     if(!animCom.getState("yaoya").isPlaying){
            //         animCom.play("yaoya");
            //     }
            //     break;
            case YSMNQ_HYC_PeopleState.治好:
