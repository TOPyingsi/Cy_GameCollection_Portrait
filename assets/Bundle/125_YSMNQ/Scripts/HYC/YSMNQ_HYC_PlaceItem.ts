...
@ccclass('YSMNQ_HYC_PlaceItem')
export class YSMNQ_HYC_PlaceItem extends YSMNQ_ItemBase {
    ...
    showOperationAnim(targetId: number): void {
        ...
        switch(this._itemId){
            ...
            case 5:
                ...
                animNode = this._operationAnimsNode.getChildByName("好牙_"+(id[this._itemId]))
                ...
                tween(this.node)
                    ...
                    .call(()=>{
                        ...
                        if(isAllShow){
                            let fengheAnimNode = animParentNode.parent.parent.getChildByName("operation_7").getChildByName("operationAnims").children[0];
                            fengheAnimNode.getComponent(Animation).play("show")
                            let a = animParentNode.parent.parent.getChildByName("operation_7").getChildByName("targets").children[0]
                            a.getComponent(Animation).play("show2")
                        }
    ...
    showPeopleReact(targetId:number): void {
        switch(this._itemId){
            ...
            case 5:
                case 6:
                YSMNQ_HYC_SecondPanel_0.Instance.showPeopleReact(targetId);
                break;
            default:
                break;
        }
