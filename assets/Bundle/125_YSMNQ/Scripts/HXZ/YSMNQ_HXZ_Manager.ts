import { _decorator, Component, Event, Label, Node, tween, UITransform, v3, Widget } from 'cc';
...
@ccclass('YSMNQ_HXZ_Manager')
export class YSMNQ_HXZ_Manager extends YSMNQ_ManagerBase {
    static Instance: YSMNQ_HXZ_Manager = null;
    ...
    onLoad(){
        YSMNQ_HXZ_Manager.Instance = this;
    }
    ...
    startGame(): void {
        ...
        this.showPeopleReact(YSMNQ_HXZ_PeopleState.迷糊);
    ...
    passGame(): void {
       ...
       this.showPeopleReact(YSMNQ_HXZ_PeopleState.治好);
    ...
    showPeopleReact(state: YSMNQ_HXZ_PeopleState): void {
          switch(state){
                case YSMNQ_HXZ_PeopleState.张嘴:
                case YSMNQ_HXZ_PeopleState.正常:
                case YSMNQ_HXZ_PeopleState.迷糊:
                    ...
                    this.peopleStatusNode.getChildByName("status_1").active = false;
                    break;
                // case YSMNQ_HXZ_PeopleState.咬紧牙关:
                //     if(!animCom.getState("yaoya").isPlaying){
                //         animCom.play("yaoya");
                //     }
                //     break;
                case YSMNQ_HXZ_PeopleState.治好:
