...
@ccclass('YSMNQ_HXZ_TweezersItem')
export class YSMNQ_HXZ_TweezersItem extends YSMNQ_ItemBase {
    ...
    showPeopleReact(targetId:number): void {
        switch(this._itemId){
            case 0:
                YSMNQ_HXZ_SecondPanel_0.Instance.showPeopleReact(YSMNQ_HXZ_PeopleState.迷糊);
                break;
            case 1:
                break;
            case 2:
                YSMNQ_HXZ_SecondPanel_0.Instance.showPeopleReact(YSMNQ_HXZ_PeopleState.咬紧牙关);
                break;
            case 3:
                YSMNQ_HXZ_SecondPanel_0.Instance.showPeopleReact(YSMNQ_HXZ_PeopleState.张嘴);
                break;
            case 4:
                 YSMNQ_HXZ_SecondPanel_0.Instance.showPeopleReact(YSMNQ_HXZ_PeopleState.咬紧牙关);
                break;
