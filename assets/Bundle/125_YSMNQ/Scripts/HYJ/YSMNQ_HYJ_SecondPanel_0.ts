...
@ccclass('YSMNQ_HYJ_SecondPanel_0')
export class YSMNQ_HYJ_SecondPanel_0 extends Component {
    static Instance: YSMNQ_HYJ_SecondPanel_0 = null;
    ...
    itemGroupIds: {itemId:number,status:boolean}[][] = [
        ...
        [{itemId:4,status:false},{itemId:5,status:false},{itemId:6,status:false}],
        [{itemId:7,status:false}]
    ];
    ...
    onLoad(){
        YSMNQ_HYJ_SecondPanel_0.Instance = this;
