...
@ccclass('YSMNQ_HYJ_TweezersItem')
export class YSMNQ_HYJ_TweezersItem extends YSMNQ_ItemBase {
    ...
    showPeopleReact(targetId:number): void {
        switch(this._itemId){
            case 0:
                YSMNQ_HYJ_SecondPanel_0.Instance.showPeopleReact(YSMNQ_HYJ_PeopleState.迷糊);
                break;
            case 1:
                break;
            case 2:
                ...
                break;
            case 3:
                YSMNQ_HYJ_SecondPanel_0.Instance.showPeopleReact(YSMNQ_HYJ_PeopleState.张嘴);
                break;
            case 4:
                 YSMNQ_HYJ_SecondPanel_0.Instance.showPeopleReact(YSMNQ_HYJ_PeopleState.咬紧牙关);
                break;
    ...
    showOperationTip(): void {
        switch(this._itemId){
            case 8:
                YSMNQ_HYJ_SecondPanel_0.Instance.showTip("用镊子夹出食物残渣");
                break;
            default:
                break;
        }
