...
@ccclass('YSMNQ_HYJ_Manager')
export class YSMNQ_HYJ_Manager extends YSMNQ_ManagerBase {
    static Instance: YSMNQ_HYJ_Manager = null;
    ...
    onLoad(){
        YSMNQ_HYJ_Manager.Instance = this;
    }
    ...
    startGame(): void {
        ...
        this.showPeopleReact(YSMNQ_HYJ_PeopleState.迷糊);
    ...
    passGame(): void {
       ...
       this.showPeopleReact(YSMNQ_HYJ_PeopleState.治好);
    ...
    showPeopleReact(state: YSMNQ_HYJ_PeopleState): void {
         switch(state){
            case YSMNQ_HYJ_PeopleState.张嘴:
            case YSMNQ_HYJ_PeopleState.正常:
            case YSMNQ_HYJ_PeopleState.迷糊:
                ...
                this.peopleStatusNode.getChildByName("status_1").active = false;
                break;
            // case YSMNQ_HYJ_PeopleState.咬紧牙关:
            //     if(!animCom.getState("yaoya").isPlaying){
            //         animCom.play("yaoya");
            //     }
            //     break;
            case YSMNQ_HYJ_PeopleState.治好:
