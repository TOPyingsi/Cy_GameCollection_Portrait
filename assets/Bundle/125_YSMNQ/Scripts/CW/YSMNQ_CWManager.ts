...
@ccclass('YSMNQ_CWManager')
export class YSMNQ_CWManager extends YSMNQ_ManagerBase {
    static Instance: YSMNQ_CWManager = null;
    ...
    startGame(): void {
        ...
        this.showPeopleReact(YSMNQ_CW_PeopleState.迷糊);
    ...
    passGame(): void {
       ...
       this.showPeopleReact(YSMNQ_CW_PeopleState.治好);
    ...
    showPeopleReact(state: YSMNQ_CW_PeopleState): void {
        let animCom = this.peopleAnim.getComponent(Animation);
        switch(state){
            case YSMNQ_CW_PeopleState.张嘴:
            case YSMNQ_CW_PeopleState.正常:
            case YSMNQ_CW_PeopleState.迷糊:
                ...
                this.peopleStatusNode.getChildByName("status_1").active = false;
                break;
            case YSMNQ_CW_PeopleState.咬紧牙关:
                if(!animCom.getState("yaoya").isPlaying){
                    animCom.play("yaoya");
                    let duration = animCom.getState("yaoya").duration;
                    this.scheduleOnce(()=>{
                        this.showPeopleReact(YSMNQ_CW_PeopleState.正常);
                    },duration);
                }
                this.peopleStatusNode.getChildByName("status_0").active = true;
                this.peopleStatusNode.getChildByName("status_1").active = false;
                break;
            case YSMNQ_CW_PeopleState.治好:
