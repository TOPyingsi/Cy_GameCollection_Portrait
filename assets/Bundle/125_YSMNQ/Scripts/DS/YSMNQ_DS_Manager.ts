...
@ccclass('YSMNQ_DS_Manager')
export class YSMNQ_DS_Manager extends YSMNQ_ManagerBase {
    static Instance: YSMNQ_DS_Manager = null;
    ...
    onLoad(){
        YSMNQ_DS_Manager.Instance = this;
    }
    ...
    startGame(): void {
        ...
        this.showPeopleReact(YSMNQ_DS_PeopleState.迷糊);
    ...
    passGame(): void {
       ...
       this.showPeopleReact(YSMNQ_DS_PeopleState.治好);
    ...
    showPeopleReact(state: YSMNQ_DS_PeopleState): void {
        let animCom = this.peopleAnim.getComponent(Animation);
        switch(state){
            case YSMNQ_DS_PeopleState.张嘴:
            case YSMNQ_DS_PeopleState.正常:
            case YSMNQ_DS_PeopleState.迷糊:
                ...
                this.peopleStatusNode.getChildByName("status_1").active = false;
                break;
            // case YSMNQ_DS_PeopleState.咬紧牙关:
            //     if(!animCom.getState("yaoya").isPlaying){
            //         animCom.play("yaoya");
            //     }
            //     break;
            case YSMNQ_DS_PeopleState.治好:
