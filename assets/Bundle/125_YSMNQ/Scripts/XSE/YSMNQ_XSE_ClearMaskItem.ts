 ...
 */
@ccclass('YSMNQ_XSE_ClearMaskManager')
export default class YSMNQ_XSE_ClearMaskManager extends YSMNQ_ItemBase {
    ...
    showOperationTip(): void {
        switch(this._itemId){
            case 0:
                YSMNQ_XSE_Manager.Instance.showTip("用毛巾擦掉胎脂");
                break;
            case 1:
                YSMNQ_XSE_Manager.Instance.showTip("用碘伏擦拭脐带");
                break;
            default:
                break;
        }
