...
@ccclass('YSMNQ_HDN_TweezersItem')
export class YSMNQ_HDN_TweezersItem extends YSMNQ_ItemBase {
    ...
    showPeopleReact(targetId:number): void {
        switch(this._itemId){
            ...
            case 2:
                ...
                break;
            case 3:
                YSMNQ_HDN_SecondPanel_0.Instance.showPeopleReact(YSMNQ_HDN_PeopleState.张嘴);
                break;
            case 4:
                 YSMNQ_HDN_SecondPanel_0.Instance.showPeopleReact(YSMNQ_HDN_PeopleState.咬紧牙关);
                break;
