...
import { YSMNQ_HDN_ItemQuilt } from './YSMNQ_HDN_ItemQuilt';


const { ccclass, property } = _decorator;

@ccclass('YSMNQ_HDN_CollisionItem')
export class YSMNQ_HDN_CollisionItem extends YSMNQ_ItemBase {
    ...
    showOperationAnim(targetId: number): void {
        ...
        let animBase: YSMNQ_AnimBase = null;
        switch(this._itemId){
                case 0:
                  ...
                  this.scheduleOnce(()=>{
                      let itemQuilt= animParentNode.children[0].getComponent(YSMNQ_HDN_ItemQuilt);
                      itemQuilt.init(()=>{
                          animParentNode.children.forEach((animNode) => {
                              let animCom = animNode.getComponent(Animation);
                              if(animCom){
                ...
                case 4:
                    ...
                    this.scheduleOnce(()=>{
                            ...
                            if(isAllHide){
                                animNode.getChildByName("脑子1").active = false;
                                 animNode.getChildByName("手术衣层-002").active = false;
                                // animNode.active = false;
                            }
                            this.node.active = true;
                            tween(this.node)
                ...
                case 6:
                    ...
                    this.scheduleOnce(()=>{
                            ...
                            let item4TargetsLayer = animParentNode.parent.parent.getChildByName("operation_7").getChildByName("targets");
                            let item4targets = animParentNode.children[0].getChildByName("item_7_items").getChildByName("targets");
                            a(item4targets,item4TargetsLayer);
                            let item5TargetsLayer = animParentNode.parent.parent.getChildByName("operation_8").getChildByName("targets");
                            let item5targets = animParentNode.children[0].getChildByName("item_8_items").getChildByName("targets");
                            a(item5targets,item5TargetsLayer);

                            let item4PressLayer = animParentNode.parent.parent.getChildByName("operation_7").getChildByName("pressArea");
                            let item4PressArea = animParentNode.children[0].getChildByName("item_7_items").getChildByName("pressArea");
                            a(item4PressArea,item4PressLayer);
                            let item5PressLayer = animParentNode.parent.parent.getChildByName("operation_8").getChildByName("pressArea");
                            let item5PressArea = animParentNode.children[0].getChildByName("item_8_items").getChildByName("pressArea");
                ...
                case 10:
                    ...
                    this.scheduleOnce(()=>{
                            ...
                            let id = this._itemId+1;

                            let item4TargetsLayer = animParentNode.parent.parent.getChildByName("operation_"+id).getChildByName("targets");
                            let item4targets = animParentNode.children[0].getChildByName("item_"+id+"_items").getChildByName("targets");
                            a(item4targets,item4TargetsLayer);
    ...
    showPeopleReact(targetId:number): void {
        switch(this._itemId){
            case 0:
                YSMNQ_HDN_SecondPanel_0.Instance.showPeopleReact(targetId);
                break;
            case 1:
                YSMNQ_HDN_SecondPanel_0.Instance.showPeopleReact(targetId);
                break;
    ...
    showOperationSpTip(): void {
        YSMNQ_HDN_SecondPanel_0.Instance.showOperationSpTip(this._itemId);
    }

    hideOperationSpTip(): void {
        YSMNQ_HDN_SecondPanel_0.Instance.hideOperationSpTip();
    }

    showNormalTip(): void {
        YSMNQ_HDN_SecondPanel_0.Instance.showTip("治疗病人");
    }

    showOperationTip(): void {
        switch(this._itemId){
            case 0:
                YSMNQ_HDN_SecondPanel_0.Instance.showTip("用手术刀切开头皮");
                break;
            case 1:
                YSMNQ_HDN_SecondPanel_0.Instance.showTip("用锯子锯开头盖骨");
                break;
            case 2:
                YSMNQ_HDN_SecondPanel_0.Instance.showTip("用棉球擦去脑部的血渍");
                break;
            case 3:
                YSMNQ_HDN_SecondPanel_0.Instance.showTip("移开大脑，露出连接血管");
                break;
            case 4:
                YSMNQ_HDN_SecondPanel_0.Instance.showTip("切断连接大脑的血管");
                break;
            case 5:
                YSMNQ_HDN_SecondPanel_0.Instance.showTip("摘除病变大脑");
                break
            case 6:
                YSMNQ_HDN_SecondPanel_0.Instance.showTip("用检测仪查看脑区");
                break
            case 7:
                YSMNQ_HDN_SecondPanel_0.Instance.showTip("用棉球擦除细菌");
                break
            case 8:
                YSMNQ_HDN_SecondPanel_0.Instance.showTip("用激光枪杀死病毒");
                break
            case 9:
                YSMNQ_HDN_SecondPanel_0.Instance.showTip("更换新大脑");
                break
            case 10:
                YSMNQ_HDN_SecondPanel_0.Instance.showTip("安装头盖骨");
                break
            case 11:
                YSMNQ_HDN_SecondPanel_0.Instance.showTip("安装头皮");
                break
            default:
                break;
        }
    ...
    passTarget(targetId: number): void {
        ...
        if(!isHave){
            ...
            YSMNQ_HDN_SecondPanel_0.Instance.passItem(this._itemId);
            this.showNormalTip();
            this.hideOperationSpTip();
        }
        else{
    ...
    onListener(){
        ...
        EventManager.on(YSMNQ_GameEvent.HDN_Item_LongPress_Completed, this.onItem_6_Completed, this);
    }

    removeListener(){
        EventManager.off(YSMNQ_GameEvent.CancelTutorial);
        EventManager.off(YSMNQ_GameEvent.HDN_Item_LongPress_Completed);
    }
