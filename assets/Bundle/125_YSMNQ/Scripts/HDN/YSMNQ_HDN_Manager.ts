...
@ccclass('YSMNQ_HDN_Manager')
export class YSMNQ_HDN_Manager extends YSMNQ_ManagerBase {
    static Instance: YSMNQ_HDN_Manager = null;
    ...
    onLoad(){
        YSMNQ_HDN_Manager.Instance = this;
    }
    ...
    startGame(): void {
        ...
        this.showPeopleReact(YSMNQ_HDN_PeopleState.迷糊);
    ...
    passGame(): void {
       ...
       this.showPeopleReact(YSMNQ_HDN_PeopleState.治好);
