...
import { YSMNQ_FR_Manager } from './YSMNQ_FR_Manager';
import { YSMNQ_FR_PeopleState } from './YSMNQ_FR_PeopleState';
...
import { YSMNQ_DS_ItemDefibrillator } from '../DS/YSMNQ_DS_ItemDefibrillator';
import { YSMNQ_FR_ItemMonitor } from './YSMNQ_FR_ItemMonitor';
const { ccclass, property } = _decorator;

@ccclass('YSMNQ_FR_CollisionItem')
export class YSMNQ_FR_CollisionItem extends YSMNQ_ItemBase {
        ...
        switch(this._itemId){
            ...
            case 2:
                 animParentNode = this._operationAnimsNode
                    ...
                    duration = animParentNode.children[0].getComponent(Animation).clips[0].duration*animParentNode.children[0].getComponent(Animation).clips[0].speed;
                    this.scheduleOnce(()=>{
                        let itemDefibrillator= animParentNode.children[0].getComponent(YSMNQ_DS_ItemDefibrillator);
                        itemDefibrillator.init(()=>{
                            animParentNode.children.forEach((animNode) => {
                                let animCom = animNode.getComponent(Animation);
                                if(animCom){
                                    animCom.stop();
            ...
            case 4:
                 animParentNode = this._operationAnimsNode
                    ...
                    duration = animParentNode.children[0].getComponent(Animation).clips[0].duration*animParentNode.children[0].getComponent(Animation).clips[0].speed;
                    this.scheduleOnce(()=>{
                        let itemDefibrillator= animParentNode.children[0].getComponent(YSMNQ_FR_ItemMonitor);
                        itemDefibrillator.init(()=>{
                            animParentNode.children.forEach((animNode) => {
                                let animCom = animNode.getComponent(Animation);
                                if(animCom){
    ...
    showPeopleReact(targetId:number): void {
        switch(this._itemId){
            case 0:
                YSMNQ_FR_Manager.Instance.showPeopleReact(YSMNQ_FR_PeopleState.迷糊);
                break;
            case 1:
                YSMNQ_FR_Manager.Instance.showPeopleReact(YSMNQ_FR_PeopleState.迷糊);
                break;
    ...
    showOperationSpTip(): void {
        YSMNQ_FR_Manager.Instance.showOperationSpTip(this._itemId);
    }

    hideOperationSpTip(): void {
        YSMNQ_FR_Manager.Instance.hideOperationSpTip();
    }

    showNormalTip(): void {
        YSMNQ_FR_Manager.Instance.showTip("治疗病人");
    }

    showOperationTip(): void {
        switch(this._itemId){
            case 0:
                YSMNQ_FR_Manager.Instance.showTip("用体温计量体温");
                break;
            case 1:
                YSMNQ_FR_Manager.Instance.showTip("给病人喂药");
                break;
            case 2:
                YSMNQ_FR_Manager.Instance.showTip("用除颤器抢救病人");
                break;
            case 3:
                YSMNQ_FR_Manager.Instance.showTip("用吹风机清理灰尘");
                break;
            case 4:
                YSMNQ_FR_Manager.Instance.showTip("用血压仪给病人量血压");
                break;
            case 5:
                YSMNQ_FR_Manager.Instance.showTip("给病人输液");
                break;
            case 6:
                YSMNQ_FR_Manager.Instance.showTip("冰敷淤伤");
                break;
            case 7:
                YSMNQ_FR_Manager.Instance.showTip("给病人打针");
                break;
            case 8:
                YSMNQ_FR_Manager.Instance.showTip("用冰袋给病人降温");
                break;
            default:
                break;
        }
    ...
    passTarget(targetId: number): void {
        ...
        if(!isHave){
            ...
            YSMNQ_FR_Manager.Instance.passItem(this._itemId);
            this.showNormalTip();
            this.hideOperationSpTip();
        }
        else{
