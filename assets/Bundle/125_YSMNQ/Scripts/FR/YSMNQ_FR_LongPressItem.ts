import { _decorator, Animation, Node,  Touch, tween, UIOpacity, UITransform, v2, v3,  Vec3 } from 'cc';
...
@ccclass('YSMNQ_FR_LongPressItem')
export class YSMNQ_FR_LongPressItem extends YSMNQ_ItemBase {
