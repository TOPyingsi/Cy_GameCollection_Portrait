...
@ccclass('YSMNQ_FR_Manager')
export class YSMNQ_FR_Manager extends YSMNQ_ManagerBase {
    static Instance: YSMNQ_FR_Manager = null;
    ...
    onLoad(){
        YSMNQ_FR_Manager.Instance = this;
    }
    ...
    startGame(): void {
        ...
        this.showPeopleReact(YSMNQ_FR_PeopleState.迷糊);
    ...
    passGame(): void {
       ...
       this.showPeopleReact(YSMNQ_FR_PeopleState.治好);
    ...
    showPeopleReact(state: YSMNQ_FR_PeopleState): void {
        let animCom = this.peopleAnim.getComponent(Animation);
        switch(state){
            case YSMNQ_FR_PeopleState.张嘴:
            case YSMNQ_FR_PeopleState.正常:
            case YSMNQ_FR_PeopleState.迷糊:
                ...
                this.peopleStatusNode.getChildByName("status_1").active = false;
                break;
            // case YSMNQ_FR_PeopleState.咬紧牙关:
            //     if(!animCom.getState("yaoya").isPlaying){
            //         animCom.play("yaoya");
            //     }
            //     break;
            case YSMNQ_FR_PeopleState.治好:
