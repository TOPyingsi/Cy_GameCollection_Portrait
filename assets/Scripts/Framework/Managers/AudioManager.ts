import { _decorator, AudioClip, AudioSource, Component, director, game, Node, resources, sys } from 'cc';
...
export class AudioManager extends Component {
    ...
    public static set IsMusicOn(value: boolean) {
        ...
        EventManager.Scene.emit(MyEvent.IsMusicOn, value);
    }
    ...
    public static set IsSoundOn(value: boolean) {
        ...
        EventManager.Scene.emit(MyEvent.IsSoundOn, value);
    }
    ...
    public static set IsVibrateOn(value: boolean) {
        ...
        EventManager.Scene.emit(MyEvent.IsVibrateOn, value);
    }
    ...
    public PlayCommonBGM(audio: Audios): void {
        ...
        if (this.audioClips.has(audio)) {
            this.PlayBGM(this.audioClips.get(audio));
        } else {
            this.LoadAudioClip(audio, () => { this.PlayBGM(this.audioClips.get(audio)); });
        }
    }
